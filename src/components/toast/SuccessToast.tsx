...
const SuccessToast = ({
  ...
  const toastId = toast.custom(
    (t: Toast) => (
      <div
        className={`max-w-md w-full bg-white dark:bg-[#191919] shadow-lg px-3 sm:px-4 py-4 sm:py-6 rounded-lg pointer-events-auto flex justify-between gap-4 border-x-8 border-[#0aaf24] ${
        ...
        <div className="">
          <div className="flex items-start">
            ...
            <div className="ml-2 sm:ml-3">
              ...
              <p className="text-xs 2xs:text-sm text-[#797b86] capitalize">
                {description}
              </p>
            </div>
          </div>
