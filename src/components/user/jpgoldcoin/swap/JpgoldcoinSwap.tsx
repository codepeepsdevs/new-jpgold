...
import { IoInformationCircle, IoSwapVerticalSharp, IoChevronDown } from "react-icons/io5";
...
const JpgoldcoinSwap = () => {
  ...
  const [selectedReceiveCrypto, setSelectedReceiveCrypto] = useState(cryptoOptions[3]);
    ...
    <div className="flex flex-col md:flex-row gap-4">
      <UserCard className="w-full md:w-1/2">
        <div className="md:p-5 space-y-6">
          <h2 className="text-xl md:text-2xl font-bold dark:text-white">Swap Token</h2>
          ...
          <div className="space-y-6 bg-[#F8F8F8] dark:bg-[#0E0E0E] p-4 border border-[#DDDDDD] dark:border-[#3D3D3D] rounded-lg">
            ...
            <div className="bg-white dark:bg-[#151515] border border-[#E6E6E6] dark:border-[#292929] rounded-lg p-2 md:p-4">
              ...
              <div className="space-y-2">
                <label className="text-lg text-[#050706] dark:text-white">You&apos;re paying</label>
                <div className="p-4 rounded-lg space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <span className="text-[#050706] dark:text-white">{selectedPayCrypto.label}</span>
                  ...
                  <p className="text-base text-[#5A5B5A] dark:text-white/70">$3,233.48</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-base text-[#5A5B5A] dark:text-white/70">You&apos;re receiving</label>
                <div className="p-4 rounded-lg space-y-4">
                  <div className="flex items-center justify-between">
                    <input
                      type="number"
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <span className="text-[#050706] dark:text-white">{selectedReceiveCrypto.label}</span>
                        <IoChevronDown className="text-[#5A5B5A] ml-1" />
                      </button>
            ...
            <div className="space-y-2">
              ...
              <div className="relative mt-2">
                <select
                  ...
                  onChange={(e) => setSelectedChain(blockchainOptions.find(chain => chain.id === e.target.value) || blockchainOptions[0])}
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                  <svg className="w-4 h-4 text-[#5A5B5A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
