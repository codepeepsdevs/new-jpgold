            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <div className="text-center">
                <div className="flex items-center justify-center">
                  <span className="text-2xl font-medium text-[#050706] dark:text-white">$</span>
                  <input
                    type="number"
                    value={amount}
                ...
                <p className="text-sm text-[#6C7574] dark:text-gray-400">0.00 ℗</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                className="w-full p-3 bg-white dark:bg-[#151515] border border-gray-200 dark:border-gray-800 rounded-lg text-[#050706] dark:text-white appearance-none pr-10"
              >
