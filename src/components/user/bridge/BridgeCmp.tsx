            ...
            <UserCard className="w-full md:w-1/2">
                <div className="p-1 lg:p-5 space-y-6">
                    ...
                    <div className="space-y-0 p-4 bg-[#F8F8F8] dark:bg-[#151515] border border-[#DDDDDD] dark:border-[#3D3D3D] rounded-xl">
                        <div className="space-y-2 border p-2 py-4 rounded-lg bg-white dark:bg-[#0E0E0E] dark:border-[#3D3D3D]">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full p-3 pl-12 appearance-none border border-[#E3E3E8] dark:border-[#3D3D3D] rounded-lg focus:outline-none focus:border-[#CC8F00] bg-white dark:bg-[#0E0E0E] text-[#0B0B0D] dark:text-white pr-10"
                                >
                        ...
                        <div className="flex justify-center py-2">
                            <div className="w-12 h-12 bg-[#F8F8F8] border border-[#E6E6E6] dark:border-none dark:bg-[#3D3D3D] rounded-full flex items-center justify-center">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm text-[#0B0B0D] dark:text-white">Amount</label>
                            <input
                                type="text"
                                value={amount}
