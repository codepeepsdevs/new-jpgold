  ...
  columnHelper.accessor("date", {
    ...
    cell: (info) => (
      <div className="space-y-1">
        <div className="text-base text-[#050706] dark:text-white">
          {info.getValue()}
        </div>
      ...
      <div className="flex items-center justify-between gap-2 md:gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full md:w-1/2 pl-10 pr-4 py-2 md:py-3 bg-white dark:bg-[#151515] border border-[#C5C5CA] dark:border-[#3D3D3D] rounded-lg text-[#050706] dark:text-white placeholder-gray-400"
            value={searchText}
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-3 px-4 py-2 md:py-3 bg-white dark:bg-[#151515] border border-[#C5C5CA] dark:border-[#3D3D3D] rounded-lg text-[#050706] dark:text-white"
          >
            <IoFilter />
            Filter
          </button>
                ...
                {table.getHeaderGroups().map((headerGroup) => (
                  ...
                  >
                    {headerGroup.headers.map((header) => (
                      <th
                        key={header.id}
                        className="px-6 py-4 text-left text-base font-medium text-[#00000099] dark:text-[#FFFFFFB2]"
                      >
                        {flexRender(
