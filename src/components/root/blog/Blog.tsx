        ...
        <div className="w-full flex justify-center bg-white dark:bg-bg-700 py-3 relative">
            <div className="container flex flex-col gap-10 items-center justify-between">
                ...
                <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <h1 className='font-bold text-[54px] text-[#0B0B0D] dark:text-white'>Blog</h1>
                    <p className='text-black/80 dark:text-white/80 text-[28px]'>
                ...
                <div className="w-full flex flex-col gap-8">
                    <h2 className='font-bold text-[34px] text-[#0B0B0D] dark:text-white'>
                        Featured Articles
                    </h2>
